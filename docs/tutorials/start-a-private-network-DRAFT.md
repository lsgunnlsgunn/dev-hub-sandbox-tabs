...
* * You have used predefined accounts as described in [Simulate a private two-node network](/tutorials/v3/create-your-first-substrate-chain) to start nodes on a single computer.
